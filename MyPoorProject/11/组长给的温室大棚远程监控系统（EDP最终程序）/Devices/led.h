...
#define  LED_1_ON      GPIO_SetBits(GPIOA,GPIO_Pin_7)
#define  LED_2_ON      GPIO_SetBits(GPIOA,GPIO_Pin_6)
#define  LED_3_ON      GPIO_SetBits(GPIOA,GPIO_Pin_5)
...
#define  LED_1_OFF        GPIO_ResetBits(GPIOA,GPIO_Pin_7)
#define  LED_2_OFF        GPIO_ResetBits(GPIOA,GPIO_Pin_6)
#define  LED_3_OFF        GPIO_ResetBits(GPIOA,GPIO_Pin_5)
